...
class R2DataLoader(DataLoader):
    ...
    def collate_fn(data):
        ...
        images_id, images, question_ids, question_masks, answer_ids,answer_masks, choice_ids= zip(*data)

        images = images[0].unsqueeze(0)

        return images_id, images, torch.LongTensor(question_ids), torch.FloatTensor(question_masks), torch.LongTensor(answer_ids),torch.FloatTensor(answer_masks), choice_ids
